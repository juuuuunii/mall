...
var config = {
    ...
    databaseURL: "https://juuuuunii-mall.firebaseio.com",
    projectId: "juuuuunii-mall",
    storageBucket: "juuuuunii-mall.appspot.com",
    messagingSenderId: "1007219515311"
  };
...
var cateAjax = new Ajax("../json/cate_left.json");
  ...
  $(".banner > li").each(function(i){
	//console.log($(this).child("div").length);
	//$(this) 바로 밑에 있는 자식 중에 div의 갯수
	//console.log(i);
...
************/
//{	"result":[{"title":"best", "data":[{},{}]}, {}, {}]   } 아래의 데이터 구조
